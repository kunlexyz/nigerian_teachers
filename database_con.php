...
<div class="red">
'.$b.'</div>
The name of your School<br />
<input id="surname" name="surname" value="'.$f.'" type="text" class="roundIt" placeholder="School:" required="required" />
<div class="red">
'.$c.'</div>
...
<duv class="ce">
		<div class="pa">
  <img src="images/bio_logo.png" style="width:35px; vertical-align:middle;" alt="Biology Practical Activity and Work Book 1 - 3"  /> YOUNG BRAIN PUBLISHERS
		</div>
		
		<a href="https://youngbrain.com.ng/app">
  <div class="btnRed btnC">Download the complete app</div><br />
